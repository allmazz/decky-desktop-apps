...
- **Browse all apps** — discovers `.desktop` files across system and user directories, including Flatpaks
...
```sh
make       # install deps, build, and package into build/decky-desktop-apps.zip
